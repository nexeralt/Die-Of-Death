...
TeleportToKillerDropdown:Add(''..child.Name..'')
end)
...
TeleportToKillerDropdown:Remove(''..child.Name..'')
end)
...
TeleportToSurvivorDropdown:Add(''..child.Name..'')
end)
...
TeleportToSurvivorDropdown:Remove(''..child.Name..'')
end)
...
TeleportToGhostDropdown:Add(''..child.Name..'')
end)
...
TeleportToGhostDropdown:Remove(''..child.Name..'')
end)
